...
/////////////////
const BotName = 'WAHYU BOT☄'; 
const instagram = 'https://instagram.com/wahyu12.id'; 
const telegram = 'https://t.me/wahyu12'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@wahyu.id')
